...
const day1 = [
    ...
    {
        time: '9:30 – 10:00',
        event: 'Брифинг по челленджам',
        detail: 'Презентация 3 SDG-треков и правил хакатона',
        type: 'normal',
    },
    {
        time: '10:00 – 10:30',
        event: 'Воркшоп: Определение проблемы',
        detail: 'Design thinking — карта первопричин',
        type: 'normal',
    },
    {
        time: '10:30 – 11:00',
        event: 'Формирование команд',
        detail: 'Распределение кейсов по командам',
        type: 'normal',
    },
    {
        time: '11:00 – 12:00',
        event: 'Работа с менторами',
        detail: 'Ротация менторов по командам',
        type: 'normal',
    },
    { time: '12:00 – 13:00', event: 'Обед', detail: '', type: 'break' },
    {
        time: '13:00 – 15:30',
        event: 'Идеация и разработка решений',
        detail: 'Брейнсторм → ранжирование → первичный прототип',
        type: 'normal',
    },
    { time: '15:30 – 16:00', event: 'Кофе-брейк', detail: '', type: 'break' },
    {
        time: '16:00 – 17:30',
        event: 'Промежуточная презентация + доработка',
        detail: '3-мин. концепт-питч каждой команды внутри группы, обратная связь ментора',
        type: 'normal',
    },
...
const day2 = [
    ...
    {
        time: '9:30 – 11:00',
        event: 'Разработка + ротация менторов',
        detail: 'Работа над прототипами',
        type: 'normal',
    },
    {
        time: '11:00 – 12:30',
        event: 'Воркшоп: Питчинг',
        detail: 'Сторителлинг, визуализация данных, дизайн питч-деков, работа с вопросами жюри',
        type: 'normal',
    },
    {
        time: '12:00 – 13:00',
        event: 'Обед + финальная подготовка',
        detail: 'Финализация материалов, питч-деков, тезисов',
        type: 'break',
    },
    {
        time: '13:00 – 14:00',
        event: 'Презентации жюри',
        detail: '6 команд × 5 мин + 2 мин Q&A',
        type: 'highlight',
    },
...
const whyJoin = [
    {
        ...
        desc: 'Работа с опытными наставниками из бизнеса, технологий и социальной сферы.',
    },
    {
        num: '02',
        title: 'Реальные задачи',
        desc: 'Вы решаете не учебные кейсы, а реальные социальные проблемы.',
    },
    {
        num: '03',
        title: 'Нетворкинг',
        desc: 'Познакомьтесь с единомышленниками, инвесторами и партнёрами.',
    },
    {
        num: '04',
        title: 'Питч перед жюри',
        desc: 'Представьте решение профессиональному жюри и получите обратную связь.',
    },
    { num: '05', title: 'Поддержка ЕС', desc: 'Мероприятие финансируется Европейским Союзом.' },
    {
        num: '06',
        title: 'Design Thinking',
        desc: 'Воркшопы по дизайн-мышлению, питчингу и визуализации данных.',
    },
];
        ...
        <div className="hk-root">
            ...
            <section className="hk-hero">
                ...
                <div className="hk-sticker">
                    ...
                    <span className="hk-sticker-sub">
                        За равенство, занятость и искоренение бедности
                    </span>
                </div>
                ...
                <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 24px' }}>
                    <div className="hk-section">
                        ...
                        <p className="hk-section-sub">
                            Каждая команда работает над одним из трёх треков Целей устойчивого
                            развития ООН.
                        </p>
